...
// Connecting to MySQL Database.
 ...
 $Sql_Query = "insert into incidents(type,email,description,media,location,time,emergency,anonymous,status) values ('$type','$email','$description','$media','$location','$time','$emergency','$anonymous','$status')";
