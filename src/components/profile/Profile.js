...
import { TouchableOpacity, Text, View, Button, Image, StyleSheet, StatusBar, Alert} from 'react-native';
...
fetch('http://192.168.43.27/reporting/logout.php', {
  method: 'POST',
  headers: {
              ...
              <Image
               ...
               style={{ width: 120, height: '25%' ,borderRadius:5,marginLeft:'30%',marginRight:'30%',borderWidth:5,borderColor:'#fff'}}
                ...
                <View style={{justifyContent:"center",alignItems:'center'}}>
                    <Text style={{fontWeight:'bold',fontSize:21,color:'#fff'}}>Reporter :: </Text>
                    <Text style={{fontWeight:'bold',fontSize:21,color:'#fff'}}>Sex :: Male</Text>
                        ...
                        <View style={styles.logout}>
                            <Button title="Click here to Logout" onPress={this.UserLogoutFunction} />
                            <View>
