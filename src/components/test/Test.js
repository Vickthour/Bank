...
class ShowIncidentList extends Component {
  ...
  componentDidMount() {
       ...
       return fetch('http://192.168.43.27/reporting/listy.php')
         .then((response) => response.json())
         .then((responseJson) => {
        ...
        <View style={styles.MainContainer_For_Show_List_Activity}>
          ...
          <ListView
            ...
            renderRow={ (rowData) => <Text style={styles.rowViewContainer} 
                     ...
                     <Text onPress={this.DeleteStudentRecord} style={{padding:13,backgroundColor:'red',borderRadius:5}}> Delete</Text>
                      </Text> }
